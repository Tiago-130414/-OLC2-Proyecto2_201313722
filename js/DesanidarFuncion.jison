...
%%
INICIO : CONT EOF {var t = { tipo : "contenidoGlobal" , contenido : $1};var tErr = tablaErrores;limpiarErrores();return {traduccion : traducir($1) , errores : tErr};}
;
...
ESTRUCTURAS_DE_CONTROL: VARIABLES                       //ya se realizo su traduccion
                      ...
                      | M_STRING                        //ya se realizo su traduccion
;

/*--------------------------------------------- FUNCIONES STRING ---------------------------------------------------------*/
M_STRING : ATRIBUTOS MET_STRING S_PuntoComa                                                     {var json = $1.concat($2);json.push({tipo : "concatenar" , contenido : $3});$$={tipo : "mstring" , contenido : json};}
         | Cadena  MET_STRING S_PuntoComa                                                       {var json = [{tipo : "concatenar" , contenido : $1}].concat($2);json.push({tipo : "concatenar" , contenido : $3});$$ = {tipo : "mstring" , contenido : json};}
;
...
CONT_VAR: Identificador S_DosPuntos TIPOS_DE_DATO  /*declaracion de variable con tipo de dato*/                                     {var json = [{tipo : "identificador" ,contenido : $1},{tipo : "concatenar" ,contenido : $2},{tipo : "tipoDato" ,contenido : $3}];$$ = json;}
        ...
        //Identificador /*declaracion de variable solo id*/                                                                         {$$ = [{tipo : "identificador" ,contenido : $1}];}
       ...
       // | Identificador S_Igual S_CorcheteAbre CONT_ASIG_ARRAY S_CorcheteCierra /*array*/                                            {var json = [{tipo : "identificador" ,contenido : $1},{tipo : "concatenar" ,contenido : " " + $2 + " "},{tipo : "concatenar" ,contenido : $3}]; json = json.concat($4);json.push({tipo : "concatenar" ,contenido : $5});$$ = json;}
        ...
        | Identificador S_DosPuntos TIPOS_DE_DATO L_CORCHETE S_Igual R_New R_Array S_ParentesisAbre EXPRESION_G S_ParentesisCierra {var exp;if(Array.isArray($9)){exp = $9;}else{exp = [$9]};var json = [{tipo : "identificador" ,contenido : $1},{tipo : "concatenar" ,contenido : $2},{tipo : "tipoDato" ,contenido : $3},{tipo : "concatenar" ,contenido : $4},{tipo : "concatenar" ,contenido : " " + $5 + " "},{tipo : "concatenar" ,contenido : " " + $6 + " "},{tipo : "concatenar" ,contenido : " " + $7 + " "},{tipo : "concatenar" ,contenido : " " + $8 + " "},{tipo : "expresion" ,contenido : exp},{tipo : "concatenar" ,contenido : " " + $10 + " "}];$$ = json;}
...
LLAMADA_FUNC: Identificador S_ParentesisAbre PARAMETROS_FUNC S_ParentesisCierra S_PuntoComa         {var temp = []; temp.push({tipo : "identificador" , contenido : $1});temp.push({tipo : "concatenar" , contenido : $2}); temp = temp.concat($3);temp.push({tipo : "concatenar" , contenido : $4});temp.push({tipo : "concatenar" , contenido : $5});$$ = { tipo : "llamadaF" , contenido : temp};}
;
...
;
 ...
 CONTENIDO_EXPRESION
    ...
    | R_Null                                                                                    {var json  = {tipo : "valor" , contenido : $1}; $$ = json;}
    ...
    | Cadena MET_STRING     /*Metodos string*/                                                  {var json  = [{tipo : "valor" , contenido : $1}].concat($2);$$ = json;}
    | ATRIBUTOS MET_STRING    /*Metodos string*/                                                {var json = $1.concat($2);$$= json;}
    | Identificador S_ParentesisAbre OPCIONAL S_ParentesisCierra MET_STRING  /*Metodos string*/ {var json = [{tipo : "identificador" , contenido : $1},{tipo : "concatenar" , contenido : $2 }].concat($3);json.push({tipo : "concatenar" , contenido : $4 });json = json.concat($5);$$ = json;}
...
L_MET_STRING : L_MET_STRING  CONT_MET_STRING                                                    {var v = []; v = $1.concat($2);$$=v;} 
             | CONT_MET_STRING                                                                  {$$ = $1;}                                       
;   

CONT_MET_STRING:  S_Punto R_CharAt S_ParentesisAbre EXPRESION_G S_ParentesisCierra               {var temp;var json = [];if(Array.isArray($4)){temp = $4;}else{temp = [$4];};json.push({tipo : "concatenar" , contenido :$1});json.push({tipo : "concatenar" , contenido :$2});json.push({tipo : "concatenar" , contenido :$3});json = json.concat(temp);json.push({tipo : "concatenar" , contenido :$5});$$ = json}
